...
public class Cuboid
{
  ...
  public IEnumerable<Coordinate3D> EnumerateTop()
  {
    ...
    )
    {
      ...
      {
        yield return new Coordinate3D(x, y, ZLength >= 0 ? Position.Z + ZLength : Position.Z);
      }
    }
  }
  ...
  public IEnumerable<Coordinate3D> EnumerateBottom()
  {
    ...
    )
    {
      ...
      {
        yield return new Coordinate3D(x, y, ZLength >= 0 ? Position.Z : Position.Z + ZLength);
      }
    }
  }
  ...
  public IEnumerable<Coordinate3D> EnumerateRight()
  {
    ...
    )
    {
      ...
      {
        yield return new Coordinate3D(XLength >= 0 ? Position.X + XLength : Position.X, y, z);
      }
    }
  }
  ...
  public IEnumerable<Coordinate3D> EnumerateLeft()
  {
    ...
    )
    {
      ...
      {
        yield return new Coordinate3D(XLength >= 0 ? Position.X : Position.X + XLength, y, z);
      }
    }
  }
  ...
  public IEnumerable<Coordinate3D> EnumerateFront()
  {
    ...
    )
    {
      ...
      {
        yield return new Coordinate3D(x, YLength >= 0 ? Position.Y + YLength : Position.Y, z);
      }
    }
  }
  ...
  public IEnumerable<Coordinate3D> EnumerateBack()
  {
    ...
    )
    {
      ...
      {
        yield return new Coordinate3D(x, YLength >= 0 ? Position.Y : Position.Y + YLength, z);
      }
    }
  }
